        ...
        <form action="login.do" method="post">
            <table>
                ...
                <tr>
                    ...
                    <!--路径后增加的参数仅仅是用来欺骗浏览器的,目的是让它以为路径发生了变化,以重新获取图片.  -->
                    <td><img src="creatImg.do" onclick="this.setAttribute('src','creatImg.do?x='+Math.random())" alt="验证码" title="点击更换" /></td>  
                    <td><span class="required"></span></td>              
                </tr>            
                <tr>
                    <td></td>
                    <td class="login_button" colspan="2">
                    <!--submit按鈕的本質就是觸發表單的onsubmit事件,而該事件內部直接調用了表單的onsubmit().  -->
